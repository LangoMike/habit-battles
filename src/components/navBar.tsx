    ...
    <nav className="w-full border-b border-white/10 bg-black/30 backdrop-blur sticky top-0 z-50">
      <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
        <div className="flex gap-4 items-center">
          <Link href="/dashboard" className="font-semibold text-white">Habit Battles</Link>
          ...
          <Link href="/friends" className="text-sm opacity-80 hover:opacity-100">Friends</Link>
